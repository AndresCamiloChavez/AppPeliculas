...
import com.devandreschavez.moviesgaston.databinding.TopRatedMoviesRowBinding
...
class TopRatedConcatAdapter(private val moviesAdapter: MovieAdapter): RecyclerView.Adapter<BaseContactHolder<*>>() {
    ...
    private inner class ConcatViewHolder(val binding: TopRatedMoviesRowBinding): BaseContactHolder<MovieAdapter>(binding.root){
        override fun bind(adapter: MovieAdapter) {
            binding.rvRatedMovies.adapter = adapter
        }
